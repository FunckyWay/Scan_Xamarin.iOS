...
namespace App2
{
    public partial class CreateBarCode : UIViewController
    {
        UIImageView barCode;
        ...
        UIAlertView alt;
        public CreateBarCode() : base("CreateBarCode", null)
        {
        ...
        public override void ViewDidLoad()
        {
            ...
            generator_btn.TouchUpInside += (sender, args) => {
                ...
                {
                    barCode.Image = cg.DealFuzzyImage(cg.CreatCodeImage((Foundation.NSString)content_utf.Text), 200);
                }
                else
                {
                    if (alt == null)
            ...
            barCode.Frame = new CoreGraphics.CGRect(50,180, 200,120);
